...
class TrainersControllerTest < ActionController::TestCase
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post :create, trainer: { age: @trainer.age, creature_id: @trainer.creature_id, location: @trainer.location, name: @trainer.name }
    end
  ...
  test "should update trainer" do
    patch :update, id: @trainer, trainer: { age: @trainer.age, creature_id: @trainer.creature_id, location: @trainer.location, name: @trainer.name }
    assert_redirected_to trainer_path(assigns(:trainer))
  end
